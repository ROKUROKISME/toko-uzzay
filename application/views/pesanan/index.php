                                    ...
                                    foreach ($permintaan as $data) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url() ?>pesanan/konfirmasi/<?= $data['id']; ?>/Diterima" onclick="return confirm('Yakin ingin Terima Pesanan Ini?')" type="button" class="btn btn-block btn-success btn-sm">
                                                    <i class="fa-solid fa-check"></i> Terima
                                                </a>
                                                <a href="<?= base_url() ?>pesanan/konfirmasi/<?= $data['id']; ?>/Ditolak" onclick="return confirm('Yakin ingin Tolak Pesanan Ini?')" type="button" class="btn btn-block btn-danger btn-sm mb-2">
