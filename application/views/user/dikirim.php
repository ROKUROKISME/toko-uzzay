                            ...
                            foreach ($mypembelian as $data) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php } else { ?>
                                            <a href="<?= site_url('user/confirmPesanan/' . $data['id_detail']) ?>" onclick="return confirm('Yakin ingin terima pesanan?')" class="btn btn-primary <?= ($this->User_model->getPenjualan($data['id_penjualan'], 'resi') == null ? 'disabled' : '')  ?>">Pesanan Diterima</a>
                                        <?php }; ?>
                                    </td>
                                </tr>
                            <?php
