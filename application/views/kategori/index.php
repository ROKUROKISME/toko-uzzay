            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><a href="<?= site_url('kategori/tambah') ?>" class="btn btn-success">
                                <i class="fas fa-plus">
                                </i> Tambah
                            </a></p>
                                ...
                                <tbody>
                                    ...
                                    foreach ($kategori as $data) : ?>
                                        <tr>
                                            ...
                                            <td><?= $data['nama'] ?></td>
                                            <td>
                                                <a href="<?= site_url('kategori/ubah/' . $data['id']) ?>" class="btn btn-info"><i class=" fas fa-pencil-alt"></i> Ubah</a>
                                                <a href="<?= site_url('kategori/hapus/' . $data['id']) ?>" onclick="return confirm('Apakah kamu ingin menghapus data ini?')" class=" btn btn-danger"><i class="fas fa-trash-alt"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php
                                        $no++;
