                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="id">Id Rekening</label>
                                    <input hidden type="text" class="form-control" name="id" id="id" value="<?= $rekening['id'] ?>">
                                    <input readonly type="text" class="form-control" value="<?= threedigit($rekening['id']) ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nama Pemilik</label>
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukan Pemilik Rekening" value="<?= $rekening['nama'] ?>">
                                    <small class="form-text text-danger"><?= form_error('nama') ?></small>
                                </div>
                                <div class="form-group">
                                    <label for="bank">Bank</label>
                                    <input type="text" class="form-control" name="bank" id="bank" placeholder="BRI/BNI/BCA/MANDIRI" value="<?= $rekening['bank'] ?>">
                                    <small class="form-text text-danger"><?= form_error('bank') ?></small>
                                    <div class="form-group">
                                        <label for="nomor">Nomor Rekekning</label>
                                        <input type="text" class="form-control" name="nomor" id="nomor" placeholder="12345678" value="<?= $rekening['nomor'] ?>">
