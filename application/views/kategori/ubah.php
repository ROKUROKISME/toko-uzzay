                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input hidden type="text" class="form-control" name="id" id="id" value="<?= $kategori['id']; ?>">
                                    <input readonly type="text" class="form-control" value="<?= threedigit($kategori['id']); ?>">
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label" for="nama">Nama Kategori</label>
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="<?= $kategori['nama']; ?>">
