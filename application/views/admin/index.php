            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><a href="<?= site_url('admin/tambah') ?>" class="btn btn-success">
                                <i class="fas fa-plus">
                                </i> Tambah
                            </a></p>
                                ...
                                <tbody>
                                    ...
                                    foreach ($admin as $data) : ?>
                                        <tr>
                                            ...
                                            <td><?= $data['username'] ?></td>
                                            <td>
                                                <a href="<?= site_url('admin/ubah/' . $data['username']) ?>" class="btn btn-info"><i class=" fas fa-pencil-alt"></i> Ubah</a>
                                                <a href="<?= site_url('admin/hapus/' . $data['username']) ?>" onclick="return confirm('Apakah kamu ingin menghapus data ini?')" class=" btn btn-danger"><i class="fas fa-trash-alt"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php
                                        $no++;
